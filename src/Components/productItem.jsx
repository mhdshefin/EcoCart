...
const ProductItem = ({ image, id, name, offer, Price, brand, itemCount, ratings, section }) => {
    ...
    return (
        <div className='relative transition-all bg-white cursor-pointer w-full max-h-[50vh] sm:min-h-[50vh] min-h-[32vh] duration-300 sm:hover:shadow-xl min-w-48 flex flex-col border rounded-xl'>
            <img onClick={(event) => {
